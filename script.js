...
function calculate (a, b) {
   oneValue = arrOne.value;
   twoValue = arrTwo.value;
   arrOne.value = oneValue.replace(/[^0-9]/g, '');            // replace(/[^0-9]/g, '') регулярное выражение ввод только числами.
   arrTwo.value = twoValue.replace(/[^0-9]/g, '');
