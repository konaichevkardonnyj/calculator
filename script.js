...
/*   i = 0;
   ...
   return result.reverse().join('').replace(/^0+/, '');    //Вовращает переворот с посимвольным разделениям через join('')
  // return document.mainForm.result.value = result

}
//difference('100000000000001234567','12345');
